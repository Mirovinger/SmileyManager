!function($, window, document, _undefined)
{
	...
	XenForo.SortableList.prototype =
	{
		...
		{
			//this.options = $list.data('options') || {};
			...
			//this.$input = this.$form.find('input[name="order"]');
			...
			//this.saveOnDrop = $list.data('saveondrop') || 'no';

			/*this.$list = $list.sortable($.extend({
				handle: '.sortableListHandle',
				//pullPlaceholder: false,
				//onCancel: $.context(this, 'onCancel'),
				onDrag: $.context(this, 'onDrag'),
				onDragStart: $.context(this, 'onDragStart'),
				onDrop: $.context(this, 'onDrop'),
				//onMousedown: $.context(this, 'onMousedown'),
